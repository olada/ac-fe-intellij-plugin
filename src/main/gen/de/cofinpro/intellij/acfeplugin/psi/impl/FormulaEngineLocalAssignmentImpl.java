...
public class FormulaEngineLocalAssignmentImpl extends ASTWrapperPsiElement implements FormulaEngineLocalAssignment {

  public FormulaEngineLocalAssignmentImpl(@NotNull ASTNode node) {
    super(node);
  }
