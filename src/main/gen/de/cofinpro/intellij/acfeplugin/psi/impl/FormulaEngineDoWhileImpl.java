...
public class FormulaEngineDoWhileImpl extends ASTWrapperPsiElement implements FormulaEngineDoWhile {

  public FormulaEngineDoWhileImpl(@NotNull ASTNode node) {
    super(node);
  }
