...
public interface FormulaEngineElementTypes {
  ...
  IElementType BUILT_IN_FUNC_DICT_GET = new FormulaEngineElementType("built in func dict_ger");
  IElementType BUILT_IN_FUNC_DICT_ISKEY = new FormulaEngineElementType("built in func dict_iskey");
  IElementType BUILT_IN_FUNC_DICT_KEYS = new FormulaEngineElementType("built in func dict_keys");
  IElementType BUILT_IN_FUNC_DICT_PUT = new FormulaEngineElementType("built in func dict_put");
  IElementType BUILT_IN_FUNC_DICT_VALUES = new FormulaEngineElementType("built in func dict_values");
