...
public class FormulaEngineIdentifierLiteralReference extends FormulaEngineReference {

    public FormulaEngineIdentifierLiteralReference(FormulaEngineIdentifierLiteral psiElement) {
        super(psiElement);
    }
    ...
    public PsiElement resolve() {
        FormulaEngineIdentifierLiteral identifierLiteral = (FormulaEngineIdentifierLiteral) myElement;
        if (identifierLiteral.getIdentifier() != null) {
